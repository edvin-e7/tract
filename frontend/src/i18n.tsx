...
const en: Dict = {
  ...
  // connection (server address + access token)
  "conn.aria": "Server & access",
  "server.label": "Server address",
  "server.placeholder": "http://your-mac.local:8080",
  "server.hint": "Your tract server. Leave empty when this page is served by the server itself.",
  "err.noServer": "Set your server address first — tap the key button.",
...
const sv: Dict = {
  ...
  "conn.aria": "Server & åtkomst",
  "server.label": "Serveradress",
  "server.placeholder": "http://din-mac.local:8080",
  "server.hint": "Din tract-server. Lämna tomt när sidan serveras av servern själv.",
  "err.noServer": "Ange serveradressen först — tryck på nyckelknappen.",
